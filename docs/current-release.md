...
- API Gateway HTTP API CloudFormation stack using OpenAPI 3.0 routes from `data_layer/openapi/data-layer-rest.openapi.json`.
...
- OpenAPI is kept as source under `data_layer/openapi/`; deployment renders the Lambda invoke URI before uploading to S3.
